package com.proyecto.inventory_service.controllers;
...
public class InventoryController {
    ...
    @ResponseStatus(HttpStatus.OK)
    public BaseResponse areInStock(@RequestBody List<OrderItemRequest> ordeItems){
        return inventoryService.areInStock(ordeItems);
    }
}
